import os
import data_pipeline, hmm_model, ms_model, regime_evaluate, portfolio_optimiser
...
port_returns, w_bull, w_bear      = portfolio_optimiser.run(train, test, prices, regimes)